...
export default function TurmaDetalhe() {
  ...
  const loadData = async () => {
    ...
    const { data: profs } = await db.turma_professores.listByTurma(turmaId);
    setTurma(t as any);
    setEscola(e as any);
    setProfessores((profs || []).map((p: any) => p.nome));
    ...
    const mapped: FreqAluno[] = ((alunos || []) as any[]).map(a => {
  ...
  useEffect(() => { loadData(); }, [turmaId, escolaId, date]);
